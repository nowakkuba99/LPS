#ifndef DEE00D69_1D5F_461A_A9A2_B6CAE2405D5A
#define DEE00D69_1D5F_461A_A9A2_B6CAE2405D5A
...
inline constexpr simd::float4x4 makeIdentity();
inline simd::float4x4 makePerspective(float fovRadians, float aspect, float znear, float zfar);
inline simd::float4x4 makeXRotate(const float angleRadians);
inline simd::float4x4 makeYRotate(const float angleRadians);
inline simd::float4x4 makeZRotate(const float angleRadians);
...
#endif /* DEE00D69_1D5F_461A_A9A2_B6CAE2405D5A */
